...
import CheckVillageScada from '../DevMonitor/CheckVillageScada'; //查看组态
import CheckWaterScada from '../DevMonitor/CheckWaterScada'; // 
import CheckSewageScada from '../DevMonitor/CheckSewageScada'; // 
...
export default {
    ...
    {
      path: 'checkVillageScada/:villageId',
      name: 'CheckVillageScada',
      component: CheckVillageScada,
      alias: './CheckVillageScada/:villageId'
		},
		{
      path: 'checkWaterScada/:villageId',
      name: 'CheckWaterScada',
      component: CheckWaterScada,
      alias: './CheckWaterScada/:villageId'
		},
		{
      path: 'checkSewageScada/:villageId',
      name: 'CheckSewageScada',
      component: CheckSewageScada,
      alias: './CheckSewageScada/:villageId'
    },
    {
      path: 'villageConfig',
      name: 'VillageConfig',
