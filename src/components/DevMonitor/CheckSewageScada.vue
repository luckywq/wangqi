<template>
    <div id="sewage_scada">
        ...
        <div class="scada-wrapper">
            <iframe src="" frameborder="0" id="scada-sewage"></iframe>
        </div>
...
export default {
    ...
    methods: {
        ...
        postMessageToChild() {
            ...
            const scada = document.getElementById('scada-sewage');
...
#sewage_scada .scada-wrapper {
  height: calc(100% - 50px);
  width: 98%;
  margin: auto;
  border-radius: 15px;
}
#sewage_scada .scada-wrapper > iframe {
  width: 100%;
  height: 100%;
  overflow: hidden;
  margin: 0;
...
#sewage_scada .scada-dialog {
  width: 800px;
  height: 500px !important;
  background: rgba(255, 255, 255, 1);
}

#sewage_scada .el-dialog__body {
  position: relative;
}
#sewage_scada .el-dialog__body div {
  width: 800px;
  height: 460px;
  position: absolute;
  left: 0;
