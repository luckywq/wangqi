<template>
  <div class="screen-header">
    ...
    <div class="screen-header-right">
      ...
      <div class="go-platform-btn" @click="goPlatform" v-if="showBtn">
        进入平台
      </div>
...
export default{
    ...
    created () {
      if (sessionStorage.getItem('userInfo')) {  //for pc
        ...
        //this.queryCorrelation.where.city_id = '1096';
        this.queryCorrelation.where.city_id = this.$parent.getQueryVariable('city_id');
        this.showBtn = false;
      }
    },
    mounted () {
