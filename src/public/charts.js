...
//echarts构建图表
    ...
    export const barCharts = (el, dataX, dataY, barColor,splitLineColor) => {
        let barW = document.body.clientWidth < 1200 ? 15 : 25;
        const barOption = {
            tooltip: {
                trigger: 'axis',
                axisPointer: {
    ...
    export const barChartsWithZoom = (el, dataX, dataY, barColor,splitLineColor) => {
        const barOption = {
            tooltip: {
                trigger: 'axis',
                axisPointer: {
    ...
    //折线图 带背景及缩放
    export const lineChartsWithZoomBG = (el, dataX, dataY) => {
        const lineOption = {
            tooltip: {
                trigger: 'axis',
                axisPointer: {
